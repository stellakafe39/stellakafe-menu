...
const catBg: Record<string, string> = {
  ...
  tostlar:                 '/categories/tostlar-burgerler.webp',
  hamburgerler:            '/categories/tostlar-burgerler.webp',
  makarnalar:              '/categories/makarnalar-pizzalar.webp',
  salads:                  '/categories/salatalar.webp',
  pizzalar:                '/categories/makarnalar-pizzalar.webp',
  tavuk_lezzetleri:        '/categories/ana-yemekler-izgaralar.webp',
  etler_izgaralar:         '/categories/ana-yemekler-izgaralar.webp',
  desserts:                '/categories/tatlilar.webp',
  corbalar:                '/categories/corbalar-kahvalti.webp',
  kahvalti:                '/categories/corbalar-kahvalti.webp',
  ...
  soguk_cikolatalar:       '/categories/soguk-icecekler-frozen.webp',
  smoothie:                '/categories/soguk-icecekler-frozen.webp',
  milkshake:               '/categories/soguk-icecekler-frozen.webp',
  frozen:                  '/categories/soguk-icecekler-frozen.webp',
  special_soguk_icecekler: '/categories/soguk-icecekler-frozen.webp',
  soguk_icecekler:         '/categories/soguk-icecekler-frozen.webp',
  sikma_meyve_sulari:      '/categories/soguk-icecekler-frozen.webp',
...
const iconFor: Record<string, React.FC<{ className?: string }>> = {
  snacks:                  PlateIcon,
  tostlar:                 PlateIcon,
  hamburgerler:            PlateIcon,
  makarnalar:              PlateIcon,
  salads:                  PlateIcon,
  pizzalar:                PlateIcon,
  tavuk_lezzetleri:        PlateIcon,
  etler_izgaralar:         PlateIcon,
  ...
  frappe:                  GlassIcon,
  soguk_cikolatalar:       GlassIcon,
  smoothie:                GlassIcon,
  milkshake:               GlassIcon,
  frozen:                  GlassIcon,
  special_soguk_icecekler: GlassIcon,
  soguk_icecekler:         GlassIcon,
  sikma_meyve_sulari:      GlassIcon,
